...
#   ./deploy/deploy_v0301.sh              # 完整流程
#   ./deploy/deploy_v0301.sh build        # 仅构建镜像
#   ./deploy/deploy_v0301.sh deploy       # 仅部署 Job
#   ./deploy/deploy_v0301.sh scheduler    # 仅设置定时
# =============================================================================
set -euo pipefail
...
IMAGE_NAME="fcstlabpro-v0301"
IMAGE_TAG="latest"
JOB_NAME="daily-btc-signal-v0301"
SCHEDULER_NAME="daily-btc-signal-v0301-trigger"
MEMORY="16Gi"
CPU="4"
...
echo ""
echo "模型信息:"
echo "  - Bull: weekly_bull_v27_orion_v4_extended_oos"
echo "  - Bear: weekly_bear_v13_T28_fgi"
echo ""
echo "关键改进:"
