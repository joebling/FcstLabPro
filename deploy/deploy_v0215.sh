#!/usr/bin/env bash
# =============================================================================
# FcstLabPro v0215 — Google Cloud Run Job 部署脚本
...
#
# 用法:
#   chmod +x deploy/deploy_v0215.sh
#   ./deploy/deploy_v0215.sh
# =============================================================================
set -euo pipefail
...
IMAGE_NAME="fcstlabpro-0215"                 # 镜像名 (v0215)
IMAGE_TAG="latest"
