# ⚠️ ARCHIVED — Phase 2.5 实验矩阵 (v0601)

> **归档日**: 2026-06-01
> **归档原因**: 该文档的 "CMD Tier 1 12 个" 分类有重大方法论缺陷:
>   1. **数据源独看**: 分类仅基于 crypto-market-data (29 个 JSON), 没与 BGeometrics (437 个 JSON) 联合考虑
>   2. **忽视历史长度**: CMD 全部 29 个指标均是 2022-12-03 起 (3.5 年), 无法在 2020-2025 基准下公平使用
>   3. **丢失互补性**: BGeo 有大量 链上/矿工/MVRV 长历史 (2012-2025, 14 年), 是 Wave 2 真正金矿
>
> **接替文档**: `docs/plans/phase2.5_feature_landscape_v0601.md`
>
> **保留价值**:
>   - §0 基准锁定声明 (2020-01-01) 仍有效, 已迁移到新文档
>   - §2 设计原则 (三坚持三避免) 仍有效
>   - §4 决策树 仍有效
>   - § 其他 部分仅供 历史参考
>
> **参考**: `docs/lessons/lesson_0601_data_governance_regime_shift.md` 中记录了该文档导致的 E18a 实验走弯路.
