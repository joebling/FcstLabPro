...
| 实验名称/版本                        | 方向   | accuracy | f1_binary | precision | recall | f1_macro | kappa   |
|--------------------------------------|--------|----------|-----------|-----------|--------|----------|---------|
| weekly_bull_model                    | bull   | 0.586    | 0.674     | 0.698     | 0.651  | 0.553    | 0.108   |
| weekly_bull_v2                       | bull   | 0.607    | 0.742     | 0.638     | 0.887  | 0.457    | 0.000   |
| weekly_bull_v3                       | bull   | 0.530    | 0.455     | 0.503     | 0.415  | 0.521    | 0.049   |
| weekly_bull_v4                       | bull   | 0.620    | 0.289     | 0.314     | 0.267  | 0.514    | 0.031   |
| weekly_bull_v5                       | bull   | 0.714    | 0.209     | 0.251     | 0.179  | 0.517    | 0.040   |
| weekly_bull_v6                       | bull   | 0.647    | 0.238     | 0.353     | 0.179  | 0.504    | 0.039   |
| weekly_bull_v6_2                     | bull   | 0.531    | 0.454     | 0.504     | 0.413  | 0.522    | 0.051   |
| weekly_bull_v7                       | bull   | 0.633    | 0.019     | 0.778     | 0.009  | 0.396    | 0.010   |
| weekly_bull_v7b                      | bull   | 0.453    | 0.563     | 0.452     | 0.747  | 0.416    | -0.061  |
| ablation_bull_A7_v1style_T14         | bull   | 0.530    | 0.452     | 0.503     | 0.411  | 0.521    | 0.049   |
| weekly_bull_ablation_base            | bull   | 0.535    | 0.450     | 0.509     | 0.403  | 0.523    | 0.056   |
| weekly_bull_ablation_fgi_only        | bull   | 0.538    | 0.452     | 0.513     | 0.404  | 0.526    | 0.062   |
| weekly_bull_ablation_fr_only         | bull   | 0.530    | 0.478     | 0.508     | 0.451  | 0.525    | 0.053   |
| weekly_bull_ablation_macro_only      | bull   | 0.514    | 0.365     | 0.476     | 0.296  | 0.486    | 0.005   |
| weekly_bull_ablation_threshold       | bull   | 0.524    | 0.539     | 0.497     | 0.589  | 0.524    | 0.055   |
| weekly_bull_ablation_triple_barrier  | bull   | 0.581    | 0.437     | 0.481     | 0.400  | 0.552    | 0.108   |
| weekly_bull_v8a                      | bull   | 0.476    | 0.568     | 0.468     | 0.724  | 0.451    | -0.026  |
| weekly_bull_v8b                      | bull   | 0.492    | 0.403     | 0.458     | 0.359  | 0.480    | -0.028  |
| weekly_bull_v8c                      | bull   | 0.500    | 0.427     | 0.470     | 0.392  | 0.492    | -0.010  |
| ablation_bear_A8_v4style_T14         | bear   | 0.569    | 0.396     | 0.345     | 0.466  | 0.531    | 0.073   |
| weekly_bear_model                    | bear   | 0.590    | 0.338     | 0.312     | 0.368  | 0.521    | 0.044   |
| weekly_bear_v2                       | bear   | 0.689    | 0.043     | 0.333     | 0.023  | 0.429    | 0.004   |
| weekly_bear_v3                       | bear   | 0.554    | 0.384     | 0.331     | 0.458  | 0.517    | 0.048   |
| weekly_bear_v4                       | bear   | 0.659    | 0.302     | 0.267     | 0.346  | 0.538    | 0.081   |
| weekly_bear_v5                       | bear   | 0.788    | 0.142     | 0.167     | 0.124  | 0.511    | 0.025   |
| weekly_bear_v6                       | bear   | 0.563    | 0.389     | 0.338     | 0.458  | 0.524    | 0.060   |
| weekly_bear_v8a                      | bear   | 0.425    | 0.469     | 0.352     | 0.704  | 0.421    | -0.024  |
| weekly_bear_v8b                      | bear   | 0.481    | 0.367     | 0.328     | 0.415  | 0.464    | -0.062  |


#### 专业分析与结论

- **高 accuracy 但低 f1/kappa 的模型**（如 v5/v6/v4/v2）多为类别不平衡或过拟合，实际信号质量有限。
- **ablation/triple_barrier/v6 等模型** accuracy、f1、kappa 均衡，泛化性好，推荐上线。
- **v8 系列**（回归、stacking、阈值优化等）有创新，但 kappa 多为负，稳定性不足，暂不建议上线。
- **Bear 方向** ablation_bear_A8_v4style_T14、v6 等模型表现较好。

**结论**：
- `weekly_bull_model`、`weekly_bull_ablation_triple_barrier`、`ablation_bear_A8_v4style_T14` 等模型为当前最优，推荐优先上线。
- 所有模型 Kappa 仍低于 0.11，需扩充信息源（链上、宏观、情绪等）以突破预测力瓶颈。
