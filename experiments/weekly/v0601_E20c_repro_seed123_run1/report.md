# 实验报告: v0601_E20c_repro_seed123_run1

**生成时间**: 2026-06-01 08:44:01

## 1. 实验概要

| 项目 | 值 |
|------|------|
| 实验名称 | v0601_E20c_repro_seed123 |
| 描述 | E20c 复现性验证 — seed=123 (原 seed=42 → kappa 0.4448) |
...
|    6.0000 |     926.0000 |     63.0000 |     0.9365 |      0.7500 |             1.0000 |          0.6000 |        0.7162 |
|    7.0000 |     947.0000 |     63.0000 |     0.9365 |      0.7500 |             1.0000 |          0.6000 |        0.7162 |
|    8.0000 |     968.0000 |     63.0000 |     0.9365 |      0.0000 |             0.0000 |          0.0000 |        0.0000 |
|    9.0000 |     989.0000 |     63.0000 |     0.7460 |      0.0000 |             0.0000 |          0.0000 |        0.0000 |
|   10.0000 |    1010.0000 |     63.0000 |     0.7460 |      0.5000 |             0.3478 |          0.8889 |        0.3708 |
...
|   26.0000 |    1346.0000 |     63.0000 |     0.8889 |      0.4615 |             1.0000 |          0.3000 |        0.4190 |
|   27.0000 |    1367.0000 |     63.0000 |     0.8889 |      0.4615 |             1.0000 |          0.3000 |        0.4190 |
|   28.0000 |    1388.0000 |     63.0000 |     0.7778 |      0.3636 |             1.0000 |          0.2222 |        0.2899 |
|   29.0000 |    1409.0000 |     63.0000 |     0.8413 |      0.6667 |             0.8333 |          0.5556 |        0.5679 |
|   30.0000 |    1430.0000 |     63.0000 |     0.6984 |      0.6122 |             0.6000 |          0.6250 |        0.3657 |
...
|   39.0000 |    1619.0000 |     63.0000 |     0.6984 |      0.3448 |             0.2381 |          0.6250 |        0.1972 |
...
```
       ...
       正例(1)       0.44      0.56      0.49       342

    accuracy                           0.88      3339
   macro avg       0.69      0.74      0.71      3339
...
| trades_sma_20       |           63 |
| ext_fgi_std_14      |           63 |
| vol_volatility_10   |           62 |
| high_50d_dist       |           57 |
| return_14d          |           56 |
| cvd_change_21       |           56 |
| volatility_10d      |           56 |
| qvol_sma_10         |           54 |
| buy_pressure_ma_10  |           52 |
| atr_21              |           47 |
| obv_sma_20          |           46 |
| macd                |           45 |
| cvd_ma_21           |           43 |
...
```yaml
experiment:
  name: v0601_E20c_repro_seed123
  description: E20c 复现性验证 — seed=123 (原 seed=42 → kappa 0.4448)
  tags:
  - weekly
  - bear
  - v0601
