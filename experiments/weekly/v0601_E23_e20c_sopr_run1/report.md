# 实验报告: v0601_E23_e20c_sopr_run1

**生成时间**: 2026-06-02 06:47:33

## 1. 实验概要

| 项目 | 值 |
|------|------|
| 实验名称 | v0601_E23_e20c_sopr |
| 描述 | Phase 2.5 Wave 3 #2: E20c (28 核心剪枝) + SOPR/CDD 家族 (15 short-horizon 派生). Wave 3 第二炮. 区别于 E22-PUELL (与价格动量共线已证伪), SOPR/CDD 是行为维度信号, 理论正交度更高. |
| 标签 | ['weekly', 'bear', 'v0601', 'phase_2_5', 'wave_3', 'e23', 'sopr', 'cdd', 'e20c_based'] |
| Git Commit | dea4e33 |
...
- **特征集**: ['technical', 'volume', 'flow', 'market_structure', 'external_fgi', 'external_sopr']
- **总特征数**: 43
...
|    8.0000 |     968.0000 |     63.0000 |     0.9206 |      0.0000 |             0.0000 |          0.0000 |        0.0000 |
|    9.0000 |     989.0000 |     63.0000 |     0.7937 |      0.0000 |             0.0000 |          0.0000 |        0.0000 |
|   10.0000 |    1010.0000 |     63.0000 |     0.7619 |      0.5161 |             0.3636 |          0.8889 |        0.3931 |
...
|   21.0000 |    1241.0000 |     63.0000 |     0.9365 |      0.7143 |             1.0000 |          0.5556 |        0.6818 |
|   22.0000 |    1262.0000 |     63.0000 |     0.9206 |      0.6154 |             1.0000 |          0.4444 |        0.5783 |
...
|   27.0000 |    1367.0000 |     63.0000 |     0.8730 |      0.3333 |             1.0000 |          0.2000 |        0.2961 |
|   28.0000 |    1388.0000 |     63.0000 |     0.8254 |      0.5600 |             1.0000 |          0.3889 |        0.4762 |
|   29.0000 |    1409.0000 |     63.0000 |     0.8889 |      0.7879 |             0.8667 |          0.7222 |        0.7135 |
|   30.0000 |    1430.0000 |     63.0000 |     0.7460 |      0.6923 |             0.6429 |          0.7500 |        0.4783 |
|   31.0000 |    1451.0000 |     63.0000 |     0.8413 |      0.7619 |             0.6154 |          1.0000 |        0.6527 |
...
|   43.0000 |    1703.0000 |     63.0000 |     0.9841 |      0.9231 |             0.8571 |          1.0000 |        0.9143 |
|   44.0000 |    1724.0000 |     63.0000 |     0.9683 |      0.6667 |             1.0000 |          0.5000 |        0.6519 |
|   45.0000 |    1745.0000 |     63.0000 |     0.9683 |      0.0000 |             0.0000 |          0.0000 |        0.0000 |
|   46.0000 |    1766.0000 |     63.0000 |     0.9841 |      0.6667 |             1.0000 |          0.5000 |        0.6595 |
|   47.0000 |    1787.0000 |     63.0000 |     0.9524 |      0.0000 |             0.0000 |          0.0000 |       -0.0216 |
|   48.0000 |    1808.0000 |     63.0000 |     1.0000 |      1.0000 |             1.0000 |          1.0000 |        1.0000 |
...
```
       ...
       正例(1)       0.43      0.54      0.48       342

    accuracy                           0.88      3339
   macro avg       0.69      0.73      0.71      3339
weighted avg       0.89      0.88      0.89      3339
...
| ext_fgi_std_14      |           49 |
| return_14d          |           49 |
| buy_pressure_ma_5   |           48 |
| buy_pressure_ma_10  |           47 |
| volatility_10d      |           45 |
| vol_volatility_10   |           44 |
| trades_sma_20       |           43 |
| qvol_sma_20         |           43 |
| low_50d_dist        |           42 |
| qvol_sma_10         |           42 |
...
```yaml
experiment:
  name: v0601_E23_e20c_sopr
  description: 'Phase 2.5 Wave 3 #2: E20c (28 核心剪枝) + SOPR/CDD 家族 (15 short-horizon
    派生). Wave 3 第二炮. 区别于 E22-PUELL (与价格动量共线已证伪), SOPR/CDD 是行为维度信号, 理论正交度更高.'
  tags:
  - weekly
  - bear
  - v0601
  ...
  - e20c_based
  category: weekly
  hypothesis: 'E22 已证明 PUELL 与价格动量/波动率共线, 无净增量 (0.4375 < 0.4505). SOPR (实现盈亏行为) +
    CDD (老币移动) 是 holder 行为维度, 理论上与价格特征正交度更高, 可能提供 E22 缺失的正交 alpha. 刻意排除 lth_sopr/sth_sopr
    (E18a 已证伪慢变量, §9).

    门槛 (§6.2 决策树, 基于 E20c 4-seed mean=0.4290): - 弱 alpha 达标: Kappa ≥ 0.4505 (+5%)
    → 继续 + 4-seed 3σ 显著性 - 强 alpha: Kappa ≥ 0.515 (+20%) → 立即 promote 候选 - 持平 0.4290~0.4505:
    视成本保留 - < 0.4290: 拒绝, 不如纯剪枝 E20c
