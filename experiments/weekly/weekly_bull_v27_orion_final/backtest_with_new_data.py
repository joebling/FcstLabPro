#!/usr/bin/env python3
"""
简化版策略回测 - 使用新生成的 Orion-BiX v27 数据
基于 kappa 方向的交易策略对比
"""
...
def load_data():
    """加载数据"""
    predictions_path = PROJECT_ROOT / "experiments/weekly/weekly_bull_v27_orion_final/fold_metrics.csv"
...
def main():
    print("=" * 80)
    print("简化版策略回测 - 使用新生成的 Orion-BiX v27 数据")
    print("=" * 80)
    ...
    stats_path = output_dir / "backtest_with_new_data_summary.csv"
