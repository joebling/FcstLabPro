# 实验报告: v0601_E21b_repro_seed123_run1

**生成时间**: 2026-06-01 08:50:45

## 1. 实验概要

| 项目 | 值 |
|------|------|
| 实验名称 | v0601_E21b_repro_seed123 |
| 描述 | E21b 复现性验证 — seed=123 (原 seed=42 → kappa 0.7695) |
...
| accuracy         | 0.9299 |
| f1_binary        | 0.8122 |
| precision_binary | 0.7969 |
| recall_binary    | 0.8282 |
| cohen_kappa      | 0.7691 |
...
|    7.0000 |     947.0000 |     63.0000 |     0.9524 |      0.8235 |             1.0000 |          0.7000 |        0.7970 |
...
|   13.0000 |    1073.0000 |     63.0000 |     0.8889 |      0.7586 |             0.6471 |          0.9167 |        0.6892 |
|   14.0000 |    1094.0000 |     63.0000 |     0.9206 |      0.8571 |             0.8824 |          0.8333 |        0.8023 |
...
|   28.0000 |    1388.0000 |     63.0000 |     0.9683 |      0.9500 |             0.9048 |          1.0000 |        0.9268 |
...
|   39.0000 |    1619.0000 |     63.0000 |     0.8413 |      0.5455 |             0.4615 |          0.6667 |        0.4531 |
...
|   49.0000 |    1829.0000 |     63.0000 |     0.8730 |      0.5556 |             1.0000 |          0.3846 |        0.4980 |
...
| down_volume_proxy    |           20 |
| volatility_5d        |           20 |
| volume_cumsum_24     |           19 |
| ema_100              |           19 |
| volume_density_sma_5 |           17 |

## 附录: 完整配置

```yaml
experiment:
  name: v0601_E21b_repro_seed123
  description: E21b 复现性验证 — seed=123 (原 seed=42 → kappa 0.7695)
  tags:
  - weekly
  - bear
  - v0601
